...
const translations = {
  ...
  zh: {
    ...
    "page-caption": "次要類別",
    "page-description":
      "我們的展廳展出了在第2類獎項中被認可的S1到S3學生的StoryMaps。今年的主題是「環境、社會和治理」(ESG)，該主題涉及我們城市可持續未來的關鍵問題。學生應用了ESG原則，建議改善我們城市在可持續性、恢復力和多樣性方面的問題。ESG主題涉及環境保護、社會包容性和資源訪問，展示了空間數據在解決問題中的潛力。",
  },
};
